...
class InstamojoConfiguration(CreateUpdateModel):
    ...
    api_key = models.CharField(
        verbose_name=_("Private API Key"), max_length=48, unique=True
    )
        ...
        if "is_active" not in exclude:
            try:
                ...
                raise ValidationError(
                    {
                        "is_active": _(
                            "Multiple configuration is active. Keep "
                ...
                if ic.api_key is not self.api_key:
                    raise ValidationError(
                        {
                            "is_active": _(
                                "Another configuration is active. "
                                "Deactivate it first."
                            )
                        }
                    )
...
class PaymentRequest(CreateUpdateModel):
    ...
    buyer_name = models.CharField(
        verbose_name=_("Buyer Name"), max_length=254, null=True, blank=True
    )
    email = models.EmailField(
        verbose_name=_("Buyer Email"), max_length=254, null=True, blank=True
    )
    ...
    email_status = models.CharField(
        verbose_name=_("Email Sent Status"),
        max_length=48,
    ...
    sms_status = models.CharField(
        verbose_name=_("SMS Sent Status"),
        max_length=48,
        choices=SENT_STATUS_CHOICES,
        null=True,
        blank=True,
    ...
    status = models.CharField(
        verbose_name=_("Status"), max_length=10, choices=STATUS_CHOICES, default=PENDING
    )

    configuration = models.ForeignKey(
        to=InstamojoConfiguration,
    ...
    created_at = models.DateTimeField(
        verbose_name=_("Created At by " "Instamojo"), blank=True, null=True
    )
    modified_at = models.DateTimeField(
        verbose_name=_("Updated At by " "Instamojo"), blank=True, null=True
    )
...
class Payment(models.Model):
    ...
    id = models.CharField(
        verbose_name=_("Payment ID"), max_length=254, primary_key=True
    )
    ...
    status = models.CharField(
        verbose_name=_("Status"), max_length=12, choices=PAYMENT_STATUS_CHOICES
    )

    fees = models.DecimalField(
        verbose_name=_("Fees by Instamojo"),
        blank=True,
        decimal_places=3,
        null=True,
        max_digits=10,
    ...
    currency = models.CharField(
        verbose_name=_("Currency"), null=True, max_length=50, blank=True
    )
    amount = models.DecimalField(
        verbose_name=_("Amount"), decimal_places=2, max_digits=10
    )
    ...
    buyer_name = models.CharField(
        verbose_name=_("Buyer Name"), null=True, blank=True, max_length=254
    )
    buyer_email = models.EmailField(
        verbose_name=_("Buyer Email"), null=True, blank=True, max_length=254
    )
    buyer_phone = models.CharField(
        verbose_name=_("Buyer Mobile"), null=True, blank=True, max_length=15
    )

    shipping_address = models.CharField(
        verbose_name=_("Shipping Address"), max_length=255, null=True, blank=True
    )
    shipping_city = models.CharField(
        verbose_name=_("Shipping City"), max_length=255, null=True, blank=True
    )
    shipping_state = models.CharField(
        verbose_name=_("Shipping State"), max_length=255, null=True, blank=True
    )
    shipping_country = models.CharField(
        verbose_name=_("Shipping Country"), max_length=255, null=True, blank=True
    )
    shipping_zip = models.CharField(
        verbose_name=_("Shipping ZIP"), max_length=255, null=True, blank=True
    )
    ...
    instrument_type = models.CharField(
        verbose_name=_("Instrument Type"), null=True, blank=True, max_length=64
    )
    billing_instrument = models.CharField(
        verbose_name=_("Billing Instrument"), null=True, blank=True, max_length=64
    )
    tax_invoice_id = models.CharField(
        verbose_name=_("Tax Invoice ID"), null=True, blank=True, max_length=64
    )
    failure_message = models.CharField(
        verbose_name=_("Failure Message"), null=True, blank=True, max_length=255
    )
    failure_reason = models.CharField(
        verbose_name=_("Failure Reason"), null=True, blank=True, max_length=127
    )
    payout = models.CharField(
        verbose_name=_("Payout"), null=True, blank=True, max_length=255
    )

    webhook_verified = models.BooleanField(
        verbose_name=_("Verified via " "WebHook?"), default=False
    )
