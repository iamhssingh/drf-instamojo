...
class InstamojoConfiguration(CreateUpdateModel):
    ...
    auth_token = models.CharField(verbose_name=_("Private Auth Token"),
                                  max_length=48,
                                  unique=True)
    salt = models.CharField(verbose_name=_("Private Salt"),
                            max_length=48,
                            unique=True)
        ...
        if "is_active" not in exclude:
            try:
                ...
                raise ValidationError({
                    "is_active":
                    _("Multiple configuration is active. Keep "
                ...
                if ic.api_key is not self.api_key:
                    raise ValidationError({
                        "is_active":
                        _("Another configuration is active. "
                          "Deactivate it first.")
                    })
...
class PaymentRequest(CreateUpdateModel):
    ...
    id = models.CharField(verbose_name=_("Payment Request ID"),
                          max_length=254,
                          primary_key=True)
    ...
    buyer_name = models.CharField(verbose_name=_("Buyer Name"),
                                  ...
                                  null=True,
                                  blank=True)
    email = models.EmailField(verbose_name=_("Buyer Email"),
                              max_length=254,
                              null=True,
                              blank=True)
    phone = models.CharField(verbose_name=_("Buyer Mobile"),
                             max_length=15,
                             null=True,
                             blank=True)
    ...
    webhook = models.URLField(verbose_name=_("Webhook URL"),
                              null=True,
                              blank=True)
    ...
    shorturl = models.URLField(verbose_name=_("Long URL"),
                               null=True,
                               blank=True)

    expires_at = models.CharField(verbose_name=_("Expires at"),
                                  max_length=30,
                                  blank=True,
                                  null=True)
...
class Payment(models.Model):
    ...
    id = models.CharField(verbose_name=_("Payment ID"),
                          max_length=254,
                          primary_key=True)
    ...
    failure_reason = models.CharField(verbose_name=_("Failure Reason"),
                                      ...
                                      blank=True,
                                      max_length=127)
    payout = models.CharField(verbose_name=_("Payout"),
                              null=True,
                              blank=True,
                              max_length=255)
